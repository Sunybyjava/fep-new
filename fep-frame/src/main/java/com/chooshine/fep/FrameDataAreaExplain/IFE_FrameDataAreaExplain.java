...
public class IFE_FrameDataAreaExplain { //规约数据区解析实现类
	...
	public static void main(String[] args) {
		...
		try {
			...
			DataInfo = FrameDataAreaExplain.IFE_ExplainDataArea("0101040405191510150476980176980174980109330025660002142609021426091915260915182209291124095757014301005757015300002700001916260952142609191626095608210939112409".toCharArray(), "90100001".toCharArray(),
					100, "88".toCharArray(), "0C".toCharArray());
		} catch (Exception ex2) {
