...
public class IFE_FrameDataAreaExplain { //规约数据区解析实现类
	...
	public static void main(String[] args) {
		...
		try {
			...
			DataInfo = FrameDataAreaExplain.IFE_ExplainDataArea("".toCharArray(), "90100001".toCharArray(),
